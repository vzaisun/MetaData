...
public class metadata_twoCountries {
	public static void main(String args[]) throws IOException {
        ...
        ArrayList<String> country_list=new ArrayList<String>();//list of countries
        ...
        while(i) {
        	...
        	if(country_list.contains(country)) {
        		String path="C:\\Metadata\\"+country+"\\metadata_"+country+".csv";   //where all data of a country exists
